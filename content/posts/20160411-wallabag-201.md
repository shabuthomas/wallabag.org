...
- [Add migration link](http://doc.wallabag.org/en/v2/user/migration.html) in documentation (Nicolas Lœuillet)
...
To download, install/upgrade wallabag, [please read our Downloads page]({filename}download.md). 
